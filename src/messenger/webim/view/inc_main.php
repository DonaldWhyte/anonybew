...
<div id="footer">
	<p>
		<a href="https://github.com/DonaldWhyte/anonybew" target="_blank" class="flink">Anonybew Messenger</a> <?php echo $anonybew_version ?>
		<br />
		based on <a href="http://mibew.org/" target="_blank" class="flink">Mibew Messenger</a> <?php echo $version ?> | (c) 2011 mibew.org
	</p>
</div>
</body>
</html>